<div>
    <div class="card p-2">
        ...
        <div class="p-2">
            @foreach ($stage->rooms->sortBy('order') as $room)
                <div class="row bg-secondary rounded text-light p-1 my-1" type="button" >
                    ...
                    <div class="col-md-auto">
                        <button class="btn btn-outline-light btn-icon btn-sm rounded" wire:click="roomDown('{{ $room->id }}')">
                        ...
                        <button class="btn btn-outline-light btn-icon btn-sm rounded" wire:click="roomUp('{{ $room->id }}')">
