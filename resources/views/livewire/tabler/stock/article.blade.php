<div class="row">
    @component('components.tabler.header', ['title'=>'Article', 'subtitle'=>'Stock', 'breadcrumbs'=>$breadcrumbs])
        <button class="btn btn-primary btn-icon" wire:click="previous">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-big-left-filled" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M9.586 4l-6.586 6.586a2 2 0 0 0 0 2.828l6.586 6.586a2 2 0 0 0 2.18 .434l.145 -.068a2 2 0 0 0 1.089 -1.78v-2.586h7a2 2 0 0 0 2 -2v-4l-.005 -.15a2 2 0 0 0 -1.995 -1.85l-7 -.001v-2.585a2 2 0 0 0 -3.414 -1.414z" stroke-width="0" fill="currentColor"></path> </svg>
        </button>
        <button class="btn btn-primary btn-icon" wire:click="next">
             ...
             <div class="col-md-auto">
                 @if ($fichier->doc_type == 0)
                     ...
                     <div class="d-flex-justify-content-between">
                         ...
                         <a type="button" class="text-danger" title="Supprimer l'image" wire:click="deleteImage('{{ $fichier->id }}')">
