<div>
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-actions">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addLangue">
    ...
    <div class="modal modal-blur fade" id="addLangue" tabindex="-1" role="dialog" aria-hidden="true" wire:ignore.self>
