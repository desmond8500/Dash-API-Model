<div>
    <div class="card p-2">
        <div class="row">
            ...
            <div class="col-auto">
                <button class="btn btn-outline-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $client->id }}">
                    ...
                    <form wire:submit.prevent="update_client">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" wire:model.defer="description" cols="30"
                                    rows="3"></textarea>
