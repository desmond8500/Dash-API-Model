...
class CompteAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse(CompteResource::collection($comptes), 'Comptes retrieved successfully');
    }
    ...
    public function store(CreateCompteAPIRequest $request)
    {
        ...
        return $this->sendResponse(new CompteResource($compte), 'Compte saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new CompteResource($compte), 'Compte retrieved successfully');
    }
    ...
    public function update($id, UpdateCompteAPIRequest $request)
    {
        ...
        return $this->sendResponse(new CompteResource($compte), 'Compte updated successfully');
    }
