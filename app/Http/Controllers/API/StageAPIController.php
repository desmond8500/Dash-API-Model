...
class StageAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse(StageResource::collection($stages), 'Stages retrieved successfully');
    }
    ...
    public function store(CreateStageAPIRequest $request)
    {
        ...
        return $this->sendResponse(new StageResource($stage), 'Stage saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new StageResource($stage), 'Stage retrieved successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendSuccess('Stage deleted successfully');
    }
}
