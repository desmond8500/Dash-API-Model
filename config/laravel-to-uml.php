...
return [
    ...
    'excludeFiles' => [
        ...
        'Repositories/CompetenceRepository.php',
        'Repositories/ExperienceRepository.php',
        'Repositories/FormationRepository.php',
        'Repositories/InteretRepository.php',
        'Repositories/LangueRepository.php',
        'Repositories/PersonneRepository.php',
        'Http/Livewire/Pages/Personne.php',
        'Http/Livewire/Pages/Personnes.php',
        'Http/Livewire/Material/Footer.php',
        'Http/Livewire/Material/Index.php',
        'Http/Livewire/Material/Navbar.php',
        'Http/Livewire/Material/Sidebar.php',
        'Http/Livewire/Tabler/Pages/Docs.php',
        'Http/Livewire/Tabler/Pages/Forgotten.php',
        'Http/Livewire/Tabler/Pages/Login.php',
        'Http/Livewire/Tabler/Pages/Profile.php',
        'Http/Livewire/Tabler/Pages/Register.php',
        'Http/Livewire/Tabler/Pages/Reglages.php',
        'Http/Livewire/Tabler/Index.php',
        'Http/Livewire/Tabler/Navbar.php',
        'Http/Livewire/Tabler/Sidebar.php',
